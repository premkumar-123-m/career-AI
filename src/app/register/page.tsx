      ...
      `}} />
            ...
            <div className="glass-panel auth-panel animate-fade-up">
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    <h1 className="text-gradient" style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Join CareerAI</h1>
                    <p style={{ color: 'var(--text-secondary)' }}>Create your account and unlock your career potential.</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem' }}>
                        ...
                        <a href="/login" style={{ color: 'var(--brand-primary)', fontWeight: 600 }}>Log In</a>
                    </div>
                </form>
            </div>
        </div>
